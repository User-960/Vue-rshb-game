<template>
  <button :class='styles.shopLinkButton' @click="$emit('onclick')">
    <a :class='styles.link' target='_blank' :href='link'>Подробнее</a> 
...
<style src='./shopLinkButton.css' module='styles'>
