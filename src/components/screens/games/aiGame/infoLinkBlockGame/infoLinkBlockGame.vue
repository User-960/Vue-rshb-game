  ...
  <div :class='styles.infoLinkWrapper' v-if='GET_INFO_LINK_BLOCK_AI'>
    <div :class='styles.infoLinkBlockGame'>
      ...
      <div :class='styles.contentText'>
        ...
        <br/>
        <p>
          В текущий момент ИИ используется и в агророботах, которые собирают урожай, борются с вредителями, дозировано распыляя средства защиты растений, эффективно вычищают посредством компьютерного зрения фермерское поле от сорняков — функционал чрезвычайно широкий.
        </p>
      </div>
