<template>
  <div :class='styles.dialogDanil'>
    ...
    <div :class='[
      styles.danil, 
      {
        [styles.taskDanilCheck]: !GET_STRAWBERRY_SPROUT || !GET_STRAWBERRY_COLOR,
        [styles.taskDanilWrite]: !GET_TOMATO_SPROUT || !GET_TOMATO_COLOR,
        [styles.mistakeDanil]: GET_STRAWBERRY_LEVEL && (GET_FIRST_MISTAKE_GN || GET_SECOND_MISTAKE_GN),
        [styles.correctDanil]: GET_STRAWBERRY_MODIFIED,
