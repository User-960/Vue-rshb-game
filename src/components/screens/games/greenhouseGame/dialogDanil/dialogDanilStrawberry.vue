<template>
  <div :class='styles.dialogDanil'>
    <div v-if='GET_STRAWBERRY_LEVEL_GH && (!GET_FIRST_MISTAKE_STRAWBERRY_GH || !GET_SECOND_MISTAKE_STRAWBERRY_GH)'
        :class='styles.dialog' 
    >
      ...
      <div :class='styles.textContent'>
        ...
        <div :class='styles.timer' 
          v-if='(!GET_FIRST_MISTAKE_STRAWBERRY_GH && !GET_SECOND_MISTAKE_STRAWBERRY_GH) && 
          (
    ...
    <div v-if='GET_STRAWBERRY_LEVEL_GH && (GET_FIRST_MISTAKE_STRAWBERRY_GH || GET_SECOND_MISTAKE_STRAWBERRY_GH)' 
        :class='[
        {
          [styles.dialogFirstMistake]: !GET_SECOND_MISTAKE_STRAWBERRY_GH && GET_FIRST_MISTAKE_STRAWBERRY_GH, 
          [styles.dialogSecondMistake]: !GET_FIRST_MISTAKE_STRAWBERRY_GH && GET_SECOND_MISTAKE_STRAWBERRY_GH
        }
      ]' 
    >
      <div :class='styles.textContent'>
        <div v-if='GET_STRAWBERRY_LEVEL_GH'>
          <p :class='[styles.text, styles.textCharacteristic]' 
            v-if='GET_FIRST_MISTAKE_STRAWBERRY_GH'
          >
            Неверно. Давай проверим все показатели еще раз.
          </p>

          <p :class='[styles.text, styles.textCharacteristic]' 
            v-if='GET_SECOND_MISTAKE_STRAWBERRY_GH'
          >
    ...
    <div :class='[
      styles.danil, 
      {
        ...
        [styles.mistakeDanil]: GET_FIRST_MISTAKE_STRAWBERRY_GH || GET_SECOND_MISTAKE_STRAWBERRY_GH,
...
export default Vue.extend({
  ...
  watch: {
    GET_TIMER_STRAWBERRY_GH() {
      if (this.GET_STRAWBERRY_LEVEL_GH && this.GET_TIMER_STRAWBERRY_GH === 0 && this.GET_PLAYER_MISTAKES_STRAWBERRY_GH === 0) {
      ...
      if (
          ...
          this.GET_PLAYER_MISTAKES_STRAWBERRY_GH === 1 && 
          !this.GET_FIRST_MISTAKE_STRAWBERRY_GH
        ) {
        this.INCREASE_PLAYER_MISTAKES_STRAWBERRY_GH()
  ...
  computed: {
    ...mapGetters([
      ...
      EN_GreenhouseGameGetters.GET_SECOND_MISTAKE_STRAWBERRY_GH,
    ]),
  },
  methods: {
    ...mapMutations([
