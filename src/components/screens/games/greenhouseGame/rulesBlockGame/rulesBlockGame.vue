      ...
      <div :class='styles.rulesContentWrapper'>
        <div :class='styles.rulesTextWrapper'>
          ...
          <div :class='styles.contentText'>
            ...
            <br/>
            <p>
              Следуя моим подсказкам, сообщай точные показания на приборах и выполняй мои рекомендации верно. Важно, чтобы индикатор жизнеспособности растения не опускался до красного уровня, иначе оно погибнет. Начнём!
            </p>
          </div>
        </div>
