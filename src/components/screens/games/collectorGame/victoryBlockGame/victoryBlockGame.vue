  ...
  <div :class='styles.victoryBlockWrapper' v-if='GET_VICTORY_BLOCK_COL'>
    <div :class='styles.victoryBlockGame'>
      ...
      <div :class='styles.contentText'>
        ...
        <br/>
        <p>
          Был собран хороший урожай, который можно продать в магазине Своё родное.  
        </p>
        <br/>
        <p>
          Качественная продукция отправится на прилавки, а ты сможешь получить долгожданную прибыль и расчитаться с банком.
        </p>
      </div>
