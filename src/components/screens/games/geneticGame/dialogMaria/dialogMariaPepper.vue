<template>
  <div :class='styles.dialogMaria'>
    <div :class='styles.dialog' v-if='GET_PEPPER_LEVEL && !GET_PEPPER_MODIFIED'>
    ...
    <div :class='styles.dialogModifiedPepper' v-else-if='GET_PEPPER_LEVEL && GET_PEPPER_MODIFIED'></div>
