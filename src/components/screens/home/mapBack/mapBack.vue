        ...
        >
          ...
          <infoBlockM v-click-outside='skipInfoIntroduction' v-if='GET_FOUR_INFO_INTRODUCTION'>
            <template v-slot:contentText>
              ...
              <br/>
              <p>
                За успешное прохождение мини игр будут начисляться баллы, которые в конце игры определяют прибыль от собранного урожая и будут указаны в таблице рейтинга всех игроков.
              </p>
              <br/>
              <p>
