      ...
      <div :class='styles.map' data-testid='map'>
        ...
        >
          ...
          <infoBlockM v-click-outside='skipInfoIntroduction' v-if='GET_FOUR_INFO_INTRODUCTION'>
            <template v-slot:contentText>
              <p>
                На главной карте изображены 3 локации: Лаборатория, Теплица и Дом. Локации открываются по мере прохождения мини игр в них. Так же можно заработать ачивки в мини играх выполняя определённые условия для их получения. За успешное прохождение мини игр будут начисляться баллы, которые в конце игры определяют прибыль от собранного урожая и будут указаны в таблице рейтинга всех игроков.
              </p>
              <br/>
              <p>
                Чтобы начать игру в первой локации "Лаборатория", обратись в банк за финансовой помощью.
              </p>
            </template>
